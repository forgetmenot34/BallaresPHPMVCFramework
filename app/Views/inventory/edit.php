    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input:focus {
            ...
            background: #fff;
            box-shadow: 0 0 0 3px rgba(11, 106, 176, 0.1);
        }
        ...
        input:focus ~ .changed-hint,
        input:not(:placeholder-shown) ~ .changed-hint {
            opacity: 1;
        }
    </style>
</head>
            ...
            <div class="form-card-header">
                <div class="form-card-icon">
                    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M14 3l3 3-9.5 9.5H4v-3L14 3z"/>
                        <line x1="11.5" y1="5.5" x2="14.5" y2="8.5"/>
                    </svg>
                </div>
                <div>
                    <h1 class="form-card-title">Edit Product</h1>
                    <p class="form-card-subtitle">Update the details for this item</p>
                </div>
